...
def dump_output(infile, outfp, file_info, debug):
    ...
    width = int(frame_info.get_width())
    height = int(frame_info.get_height())
    ...
    chroma_format = int(frame_info.get_chroma_format())
    bit_depth_luma = int(frame_info.get_bit_depth_luma())
    bit_depth_chroma = int(frame_info.get_bit_depth_chroma())
